...
const sendPasswordResetOTP = async (email, otp, name = 'User') => {
  try {
    ...
    const mailOptions = {
      from: `"Hitchhike" <${process.env.SMTP_FROM_EMAIL || process.env.SMTP_USER}>`,
      to: email,
      subject: 'Password Reset OTP - Hitchhike',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <p style="margin: 10px 0 0 0; font-size: 16px;">Hitchhike Security</p>
            </div>
            
            <div class="content">
              <h2 style="color: #333; margin-bottom: 10px;">Hi ${name}! 👋</h2>
              <p class="message">
                We received a request to reset your password for your <strong>Hitchhike</strong> account.
              </p>
              ...
              <p class="message">
                Enter this code in the app along with your new password to reset your account password.
              </p>
      ...
      text: `
        ...
        We received a request to reset your password for your Hitchhike account.
        
        Your password reset code is: ${otp}
        
        This code will expire in 10 minutes.
        
        Enter this code in the app along with your new password to reset your account.
        
        If you didn't request this, please ignore this email and your password will remain unchanged.
        
        - Hitchhike Security Team
      `,
    };
